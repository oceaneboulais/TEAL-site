function Data = loadDrifterLog(data_filename)
...
%09/20/2022
%
% edited by A. Laferriere for backward compatibility August 2023
...
elseif size(data_matrix,2)== 47
    ...
    %25. OP2?
    %26. VALVE_INDEX
    Data.OP = data_matrix(:,25);
    Data.VALVE_INDEX = data_matrix(:,26);
end
