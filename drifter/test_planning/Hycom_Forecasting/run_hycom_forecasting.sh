...
starttime=`date +%s`
RUNDIR="/home/aandriat/Hycom_Forecasting"
mkdir $RUNDIR/LOGS
...
bash $RUNDIR/Plot/Advection/run_makefigure_advection_image.sh > $RUNDIR/LOGS/run_makefigure_velocity_image.log 2>&1
...
bash $RUNDIR/Plot/Advection/run_makefigure_advection_movie.sh > $RUNDIR/LOGS/run_makefigure_velocity_movie.log 2>&1
