function [S,F,T,ch_select,sensor_type] = getDrifterSTFTV2(y,nfft,noverlp,fs,config_file,type)
...
for ich = 1:size(y,2)    
    ...
    [S(:,:,k),F,T] = stft(y(:,ich),fs,'Window',win,'OverLapLength',noverlp,'FFTLength',nfft);
