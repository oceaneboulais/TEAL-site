...
if save_to_ppt
    title_slide = sprintf('VLA Deployment #%i',...
        deployment);
...
%         end
        ...
        ch_str = sprintf('CH%i %s',ch_select(sensID),acoustic_config.sensor_type{sensID});
...
%         linkaxes(ax,'x')
        ...
        if save_plots
            png_savename = sprintf('VLA_Deployment_%i_CH%i_%s_%s_%s',...
                deployment, ...
                ch_select(sensID),acoustic_config.sensor_type{sensID},...
