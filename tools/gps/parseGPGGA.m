...
% gpsData = parseGPGGA(line,start_day)
% this function parses a line of gps data in GPGGA format
% INPUTS:
%   line: the line of the file with $GPGGA in it
%   start_day: datetime containing the start day associated with this line
% OUTPUT: gpsData, a table entry with variables:
%   time_utc
%   latitude
%   longitude
%   fixQuality
